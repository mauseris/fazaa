...
const AssistantAPI = (function () {
  ...
  return {
    ...
    matchEntrepreneurs: (sector, city, lang) => post("/entrepreneurs", { sector, city, lang }),
    getMentors: (lang) => get(`/mentors?lang=${lang || "ar"}`),
    getSuccessStories: (lang) => get(`/success-stories?lang=${lang || "ar"}`),
